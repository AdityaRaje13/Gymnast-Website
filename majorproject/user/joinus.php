...
<div class="frmcontainer">
    <form method="post" name="regiform" class="frm">
        ...
        <div class="btnlogin">
            <div>
            <button name="btnlog" id="btnlog" type="submit" required>Join Now</button>
            </div>

            <div>
                <button name="btnres" id="btnres" type="reset">Reset</button>
            </div>
        </div>
...
<?php
   ...
   if(isset($_POST['btnlog']))
   {
        ...
        $q2 = "INSERT INTO `registration`(`email`, `address`, `gender`, `course`, `time`, `date`) 
                  VALUES ('$em', '$address', '$gender', '$course', '$time', '$date')";
        ...
        $result = mysqli_query($cn,$q2);
            ...
            {
                echo "<script>
                    let ans = confirm('Your Registration is Succesfull...! Please Checkout your Profile');
            ...
            {
                echo "<script>alert('You already Registered youself. Please try with another Email...!')</script>";
            }
